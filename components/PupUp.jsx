      ...
      z-50 outline-none focus:outline-none"
        >
          <div className="relative w-auto my-6 mx-auto max-w-3xl">
            {/*content*/}
            <div
                className="border-0 rounded-lg shadow-lg relative flex flex-col  bg-white
          outline-none focus:outline-none w-[500px]"
            >
              {/*  header */}
              ...
              <div className="relative p-6 flex-auto">
                ...
                rounded shadow-sm appearance-none focus:border-teal-400 focus:outline-none focus:shadow-outline"
                    id="donateAmount"
                    name="donateAmount"
                />
                ...
                {allDonations?.map((donate, i) => (
                    <p className="my-4 text-slate-500 text-lg leading-relaxed" key={i}>
                      {formatAddress(donate.donator)} {""} Donated
                      {""} {donate.donation} ETH
              ...
              <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                <button
                    className="text-red-300 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none
